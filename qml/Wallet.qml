...
Rectangle {
    ...
    Rectangle {
        ...
        Text {
            ...
            color: "#858585"
            text: "Copy your address to receive WEAK"
    ...
    Rectangle {
        ...
        Button {
            ...
            onClicked: {
                ...
                dialogConfirmTransfer.show(rectangleTransfer.transferRecipient, rectangleTransfer.transferAmount + " WEAK + " + rectangleTransfer.transferFee + " (fee) + " + rectangleTransfer.nodeFeeValue + " (node fee)", rectangleTransfer.transferPaymentID);
            }
        }
